...
### 12. `.obsidian/plugin-data` ban-lift allowlist — only thirteen paths, only via the installer/bootstrap, only with the four safety mechanics

The `.obsidian/` ask-before-acting gate is lifted for exactly thirteen paths:
