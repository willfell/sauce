...
### 12. `.obsidian/plugin-data` ban-lift allowlist + `.claude/skills/` skill-materialization carve-out — fourteen sanctioned write zones, only via the installer/bootstrap, only with the four safety mechanics
