# Next-cycle handoff — after wiki blueprint (v0.163.0)
...
## State
- Merged origin/main (v0.161.1) into the branch; full preflight + preflight-bumped green. Pipeline will compute v0.163.0.
...
1. Let the release pipeline ship v0.163.0 (never admin-merge the release PR; unstick a BEHIND-wedge only via `gh pr update-branch`).
