...
Helper: `platform/blueprints/cowork/helpers/discover-people-helper.js` (pure, materialized to `spice/cowork/helpers/discover-people-helper.js` on consumer vaults per the canonical `spice/cowork/helpers/...` + `tag: platform` pattern).
