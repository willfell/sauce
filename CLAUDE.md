...
- **Cycle order:** v0.1.0 ✅ → v0.1.1 ✅ → v0.1.x ✅ → v0.1.3 ✅ → v0.1.2 ✅ → v0.2.0 ✅ → v0.3.0 ✅ → v0.4.0 ✅ → **next TBD (v0.4.1 invoke_command nav-button action type OR v0.3.2 meetings blueprint OR v0.2.1 project migration to `beacon/projects/`)**.
- **Workshop version:** `0.8.0` (bumped from 0.7.0 in v0.4.0 S2 — runTemplaterTemplate + applyTemplaterFolderTemplates + to-do; tag `v0.8.0` annotated and pushed).
- **Mechanisms:** `customjs-guard@1.0.0`, `validator@0.1.1`, `audit@0.1.1`, `nav-buttons@2.1.0` (bumped from 2.0.0 in v0.4.0 S1 — runTemplaterTemplate action type).
- **Blueprints:** `boards@0.1.0` (Kanban board + date-routed cards under `beacon/boards/`), `daily@0.1.0` (date-organized daily notes under `beacon/daily/` via core Daily Notes plugin + ported `SpaceDailyDashboard`), `project@0.3.0` (v0.2.0 BREAKING: Board contribution moved to boards; `module_directory: "projects-legacy"` stopgap), `to-do@0.1.0` NEW (date-routed daily to-do under `beacon/to-do/YYYY/MM-MMMM/YYYY-MM-DD-ToDo.md`; canonical first consumer of runTemplaterTemplate + templater_folder_templates; lights up SpaceDailyDashboard's tasks panel).
