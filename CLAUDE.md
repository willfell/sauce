...
- **Workshop version:** `0.4.1` (bumped from 0.4.0 in v0.1.3 S2 — additive contract change worth a tag).
...
- **Landmines list:** 12 entries (#12 — `.obsidian/` plugin-data ban-lift allowlist — codified in landmines.md + CLAUDE.md "Ask before acting").
