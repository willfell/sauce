...
- **Workshop version:** `0.33.0` (bumped from 0.32.0 in v0.33.0 — sauce claude cohesion wave 2; tag `v0.33.0` annotated). Manifest `date: "2026-05-12"`.
