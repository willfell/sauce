...
warnings: [cadence_disabled:midday-tripwire:engagement-type, contract_version_mismatch:0.34.0:0.32.0]
---
...
>
> This file was generated against sauce 0.93.2 + cowork 0.32.0 + contract 0.34.0. When the sauce version moves past 0.93.2, re-run `/cowork sync-scheduled-jobs no-tripwire` to refresh.
...
VOICE (NON-NEGOTIABLE): apply spice/cowork/context/user-preferences.md personality.notes verbatim AND personality.{vibe, formality, length, pep_talk}. Personal engagement; midday-tripwire disabled at engagement-type level.
...
> Reason: disabled via engagement-type. If this is wrong, edit `spice/cowork/context/engagement-types/personal.json` and re-run sync.
