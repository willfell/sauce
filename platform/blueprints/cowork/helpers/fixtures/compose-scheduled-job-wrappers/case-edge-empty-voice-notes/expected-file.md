...
warnings: [contract_version_mismatch:0.34.1:0.32.0, empty_voice_notes]
---
...
>
> This file was generated against sauce 0.93.2 + cowork 0.32.0 + contract 0.34.1. When the sauce version moves past 0.93.2, re-run `/cowork sync-scheduled-jobs no-voice-eng` to refresh.
...
VOICE (NON-NEGOTIABLE): apply spice/cowork/context/user-preferences.md personality.notes verbatim AND personality.{vibe, formality, length, pep_talk}. 
