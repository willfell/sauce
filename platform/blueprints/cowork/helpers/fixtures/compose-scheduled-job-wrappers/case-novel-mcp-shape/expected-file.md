...
>
> This file was generated against sauce 0.93.0 + cowork 0.31.0 + contract 0.31.0. When the sauce version moves past 0.93.0, re-run `/cowork sync-scheduled-jobs consulting-client-x` to refresh.
...
email served-by smtp-mcp-uuid; github served-by github; slack served-by slack-mcp-uuid-novel

VOICE (NON-NEGOTIABLE): apply spice/cowork/context/user-preferences.md personality.notes verbatim AND personality.{vibe, formality, length, pep_talk}. Professional, concise, focused on deliverables; no internal jargon.
