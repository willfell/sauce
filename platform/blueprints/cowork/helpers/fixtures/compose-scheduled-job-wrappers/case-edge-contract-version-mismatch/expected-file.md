...
engagement_id: version-skew
sauce_version: 0.93.0
cowork_version: 0.30.0
contract_version: 0.31.0
generated_at: 2026-06-05T14:43:33-06:00
generated_by: cowork:sync-scheduled-jobs@1.0.0
warnings: [contract_version_mismatch:0.31.0:0.30.0]
---

# Cowork scheduled-job wrappers — Version Skew Engagement

> [!warning]+ Warnings from generation
> contract_version_mismatch:0.31.0:0.30.0
...
>
> After all sections are pasted, run `/cowork morning-briefing version-skew` in Claude Code as a smoke test.
>
> This file was generated against sauce 0.93.0 + cowork 0.30.0 + contract 0.31.0. When the sauce version moves past 0.93.0, re-run `/cowork sync-scheduled-jobs version-skew` to refresh.

---

## 1 — cowork-morning-briefing-version-skew (08:00 daily)
<!-- section_contract_version: 0.31.0 -->

````
Use skill cowork:morning-briefing with { engagement_id: "version-skew" }.
...
VOICE (NON-NEGOTIABLE): apply spice/cowork/context/user-preferences.md personality.notes verbatim AND personality.{vibe, formality, length, pep_talk}. Tests cowork_version skew against contract_version.
...
## 2 — cowork-midday-tripwire-version-skew (12:30 daily)
<!-- section_contract_version: 0.31.0 -->

````
Use skill cowork:midday-tripwire with { engagement_id: "version-skew" }.
...
## 3 — cowork-eod-review-version-skew (17:00 daily)
<!-- section_contract_version: 0.31.0 -->

````
Use skill cowork:eod-review with { engagement_id: "version-skew" }.
...
## 4 — cowork-weekly-review-version-skew (17:30 Friday)
<!-- section_contract_version: 0.31.0 -->

````
Use skill cowork:weekly-review with { engagement_id: "version-skew" }.
...
## 5 — cowork-monthly-review-version-skew (last weekday 17:30)
<!-- section_contract_version: 0.31.0 -->

````
Use skill cowork:monthly-review with { engagement_id: "version-skew" }.
