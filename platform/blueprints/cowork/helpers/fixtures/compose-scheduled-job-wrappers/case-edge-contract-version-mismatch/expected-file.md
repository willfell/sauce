...
warnings: [contract_version_mismatch:0.34.1:0.30.0]
---

# Cowork scheduled-job wrappers — Version Skew Engagement

> [!warning]+ Warnings from generation
> contract_version_mismatch:0.34.1:0.30.0
...
>
> This file was generated against sauce 0.93.2 + cowork 0.30.0 + contract 0.34.1. When the sauce version moves past 0.93.2, re-run `/cowork sync-scheduled-jobs version-skew` to refresh.
