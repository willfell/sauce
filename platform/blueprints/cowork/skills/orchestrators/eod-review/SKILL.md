...
13. READ `.claude/skills/cowork/skills/update-active-threads/SKILL.md` in full and follow
...
14. READ `.claude/skills/cowork/skills/update-weekly-snapshot/SKILL.md` in full and follow
