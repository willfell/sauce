...
5. Use Skill `cowork:invoice-prep` with `{ month: "<prev_month_year>-<prev_month_num>", rate: 150 }`. This is the AUTHORITATIVE month-close invoice run. Capture the full payload.
