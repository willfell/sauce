...
class FinanceStatus {
    ...
    async renderBadge(dv, type) {
        ...
        const palette = {
            ...
            muted:   { dot: "var(--text-muted)", border: "var(--sauce-hairline)", bg: "transparent" }
        };
        ...
        const chip = row.createEl("span", { cls: "fs-status-pill sauce-pill" });
        chip.style.cssText = `background: ${p.bg}; color: var(--text-normal); border-color: ${p.border}; letter-spacing: 0.02em;`;
