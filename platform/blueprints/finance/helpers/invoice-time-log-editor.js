...
class InvoiceTimeLogEditor {
    async render(dv) {
        ...
        addBtn.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 5v14"/><path d="M5 12h14"/></svg><span>Add Entry</span>`;
        ...
        addBtn.onclick = () => this._addFlow(file, dv, entries, siblingInvoicePath);
