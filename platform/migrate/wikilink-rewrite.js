...
const LEGACY_PATH_SUBSTITUTIONS = [
    ...
    { from: /Resources\/Views\/customjs-guard/g, to: "ranch/views/customjs-guard" },
    { from: /Resources\/Templates\//g, to: "ranch/templates/" },
    { from: /Resources\/Scripts\//g, to: "ranch/scripts/" },
    { from: /Resources\/Views\//g, to: "ranch/views/" },
    ...
    { from: /(?<![/\w])[Bb]oards\/planning(?![/\w-])/g, to: "spice/projects" },
    { from: /[Bb]oards\/trips\//g, to: "spice/trips/" },
    { from: /(?<![/\w])[Bb]oards\/trips(?![/\w-])/g, to: "spice/trips" },
    { from: /[Bb]oards\/kanban-cards\//g, to: "spice/boards/kanban-cards/" },
    { from: /[Bb]oards\/to-do-cards\//g, to: "spice/boards/to-do-cards/" },
    { from: /[Bb]oards\/to-do\//g, to: "spice/boards/to-do/" },
    { from: /[Bb]oards\/side-quests\//g, to: "spice/boards/side-quests/" },
    { from: /(?<![/\w])[Bb]oards\/side-quests(?![/\w-])/g, to: "spice/boards/side-quests" },
