...
async function run(ctx, args) {
    ...
    const lines = [
        ...
        "  run         Run a graph note through the Sauce engine: sauce run <note> [--follow|--dry-run|--status|--sweep|--list] [--worker fake|claude-code|codex] [--json]. Exit: 0 = done/parked, 1 = failed, 2 = refusal.",
