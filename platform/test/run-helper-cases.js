...
async function caseHCV0891Versions() {
  ...
  assertEqual(coworkMan.version, "0.37.0", "HC-V0891-VERSION-A: cowork pin = 0.31.0 (v0.93.0 bump)");
  ...
  assertEqual(wsVer, "0.98.1", "HC-V0891-VERSION-C: workshop pin = 0.93.3 (v0.93.3 bump)");
  const pkg = JSON.parse(fs.readFileSync(
    path.resolve(WORKSHOP, "..", "package.json"), "utf8"));
  assertEqual(pkg.version, "0.98.1", "HC-V0891-VERSION-C: package.json = 0.93.3 (v0.93.3 bump)");
...
(async function main() {
...

  {
    ...
    try {
      ...
      assertTrue("HC-V0900-VERSION-A: package.json version === '0.93.3'", pkg.version === "0.98.1");
      ...
      assertTrue("HC-V0900-VERSION-D: ranch platform-subscription cowork pin === '0.31.0'",
        cworkPin && cworkPin.version === "0.37.0");
    } catch (e) {
...
`;
  ...
  try {
    ...
    assertTrue("HC-V0920-VERSION-A2: blueprints[].cowork.version === 0.31.2",
      platMan.blueprints.find(b => b.name === "cowork").version === "0.37.0");
    const pkg = JSON.parse(fs.readFileSync(path.join(WORKSHOP, "package.json"), "utf8"));
    ...
    assertTrue("HC-V0920-VERSION-A4: workshop subscription cowork pin === 0.31.0",
      workshopSub.blueprints.find(b => b.name === "cowork").version === "0.37.0");
  } catch (e) {
