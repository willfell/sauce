...
async function caseHCV0891Versions() {
  ...
  assertEqual(wsVer, "0.94.0", "HC-V0891-VERSION-C: workshop pin = 0.93.3 (v0.93.3 bump)");
  const pkg = JSON.parse(fs.readFileSync(
    path.resolve(WORKSHOP, "..", "package.json"), "utf8"));
  assertEqual(pkg.version, "0.94.0", "HC-V0891-VERSION-C: package.json = 0.93.3 (v0.93.3 bump)");
...
(async function main() {
...

  {
    ...
    try {
      ...
      assertTrue("HC-V0900-VERSION-A: package.json version === '0.93.3'", pkg.version === "0.94.0");
      ...
      assertTrue("HC-V0900-VERSION-B: platform/manifest.json workshop_version === '0.93.3'",
        platMan.workshop_version === "0.94.0");
      const coworkMan = JSON.parse(fs.readFileSync(
        path.join(WORKSHOP, "platform/blueprints/cowork/manifest.json"), "utf8"));
