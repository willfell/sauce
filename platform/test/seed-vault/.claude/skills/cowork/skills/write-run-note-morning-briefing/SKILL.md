...
5. Invoke `writeAtomicNote({ mdPath, sidecarPath, body_md, sidecar_json: input.sidecar_json, schemaPath: <vault>/.claude/skills/cowork/data/schemas/morning-briefing@1.0.0.json })` from `write-atomic-note-helper.js`.
