...
function assertCoworkV068Shape() {
  ...
  assertTrue(manifest.version === "0.35.2",
    `V0750-VERSION: cowork manifest.version === "0.35.2" (got ${JSON.stringify(manifest.version)})`);
}
...
// RETIRED in v0.92.0: HC-V0780-E1 tested the v0.78.0 composeBody(dispatch_mode,
// prefs, ordered_blocks{markdown}, synopsis, tip, prompt_body) contract that
// returned { body, prompt_body_with_voice }. v0.92.0 supersedes that with a
