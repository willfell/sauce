...
Helper: `platform/blueprints/cowork/helpers/find-missing-people-helper.js` (pure, materialized to `spice/cowork/helpers/find-missing-people-helper.js` on consumer vaults per the canonical `spice/cowork/helpers/...` + `tag: platform` pattern).
